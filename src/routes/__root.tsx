...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Sibiso Marketing — Turn Your Visibility Into Revenue" },
      {
      ...
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/6qWZov4tglQVz0lGHkWVgkSQwYl1/social-images/social-1783655798945-sibisobanner.webp" },
      ...
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/6qWZov4tglQVz0lGHkWVgkSQwYl1/social-images/social-1783655798945-sibisobanner.webp" },
    ],
    links: [
